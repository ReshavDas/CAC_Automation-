...
public abstract class DesktopElement extends RemoteWebElement {
	...
	private String elementCommandOutputPath = "";
	...
	public void setElementCommandOutputPath(String commandOutputPath) {
		this.elementCommandOutputPath = commandOutputPath;
	}
	
	public String getElementCommandOutputPath() {
		return this.elementCommandOutputPath;
	}
