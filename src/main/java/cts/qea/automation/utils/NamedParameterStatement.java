...
public class NamedParameterStatement {
	...
	private final static Map indexMap = new HashMap();;
	...
	static final String parse(String query) {
        // following code regular expressions didn't work well parameter-like strings inside quotes.
    ...
    /**
     * This method is used to set list of values for IN parameter
     * @param name
     * @param value
     * @throws SQLException
     */
	/* TODO needs to develop and solution needs to bring
	 * public void setInParameter(String name, List value) throws SQLException {
	 * int[] indexes = getIndexes(name); for(int i=0; i < indexes.length; i++) {
	 * statement.setObject(indexes[i], value); } }
	 * 
	 * public void setInParameter(String name, Set value) throws SQLException {
	 * int[] indexes = getIndexes(name); for(int i=0; i < indexes.length; i++) {
	 * statement.setObject(indexes[i], value); } }
	 */
	...
	public static void clearIndexmap() {
		indexMap.clear();
	}
}